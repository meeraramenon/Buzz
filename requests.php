...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylesheets/requeststyle.css">
    ...
    <div class="container">
        ...
        if($query){
            ...
            while($row = mysqli_fetch_assoc($query)){
                ...
                echo '<input class="button" type="hidden" name="name" value="' . $row['user_firstname'] . '">';
                echo '<input class="button" type="submit" value="Accept" name="accept">';
                echo '<br><br>';
                echo '<input class="button" type="submit" value="Ignore" name="ignore">';
                echo '<br><br>';
                echo'</form>';
                echo '</div>';
                echo '<br>';
